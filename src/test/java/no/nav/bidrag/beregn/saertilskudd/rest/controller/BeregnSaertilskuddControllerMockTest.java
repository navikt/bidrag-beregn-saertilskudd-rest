...
class BeregnSaertilskuddControllerMockTest {
  ...
  void skalReturnereTotalSaertilskuddResultatVedGyldigInput() {
    ...
    when(beregnSaertilskuddServiceMock.beregn(any(BeregnTotalSaertilskuddGrunnlag.class)))
        .thenReturn(HttpResponse.Companion.from(OK,
  ...
  void skalReturnere400BadRequestNaarInputDataMangler() {
    ...
    when(beregnSaertilskuddServiceMock.beregn(any(BeregnTotalSaertilskuddGrunnlag.class))).thenReturn(HttpResponse.Companion.from(BAD_REQUEST));
  ...
  void skalReturnere500InternalServerErrorNaarKallTilServicenFeiler() {
    ...
    when(beregnSaertilskuddServiceMock.beregn(any(BeregnTotalSaertilskuddGrunnlag.class)))
        .thenReturn(HttpResponse.Companion.from(INTERNAL_SERVER_ERROR));
