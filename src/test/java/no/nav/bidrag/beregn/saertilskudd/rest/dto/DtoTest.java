...
class DtoTest {
  ...
  void skalKasteIllegalArgumentExceptionNaarBeregnDatoFraErNull() {
    ...
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("beregnDatoFra kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarBeregnDatoTilErNull() {
    ...
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("beregnDatoTil kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarGrunnlagListeErNull() {
    ...
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("grunnlagListe kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarGrunnlagReferanseErNull() {
    ...
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("referanse kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarGrunnlagTypeErNull() {
    ...
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("type kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarGrunnlagInnholdErNull() {
    ...
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("innhold kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarInntektTypeErNull() {
    var grunnlag = new InntektBase(LocalDate.parse("2021-08-18"), LocalDate.parse("2022-08-18"), Rolle.BP, null, BigDecimal.valueOf(400000));
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::validerInntekt).withMessage("inntektType kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarBelopErNull() {
    ...
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::validerInntekt).withMessage("belop kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarDeltFordelErNull() {
    var grunnlag = new BMInntekt(LocalDate.parse("2021-08-18"), LocalDate.parse("2022-08-18"), "INNTEKTSOPPLYSNINGER_ARBEIDSGIVER",
        BigDecimal.valueOf(400000), Rolle.BM, null, false);
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("deltFordel kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarSkatteklasse2ErNull() {
    ...
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("skatteklasse2 kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarSoknadsbarnErNull() {
    var grunnlag = new SBInntekt(LocalDate.parse("2021-08-18"), LocalDate.parse("2022-08-18"), Rolle.SB, "INNTEKTSOPPLYSNINGER_ARBEIDSGIVER",
        BigDecimal.valueOf(400000), null);
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("soknadsbarnId kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarAntallErNull() {
    ...
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("antall kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarBostatusKodeErNull() {
    ...
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("bostatusKode kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarSaerfradragKodeErNull() {
    ...
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("saerfradragKode kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarSkatteklasseIdErNull() {
    ...
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("skatteklasseId kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarNettoSaertilskuddBelopErNull() {
    ...
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("nettoSaertilskuddBelop kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarSamvaersklasseSoknadsbarnFodselsdatoErNull() {
    ...
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("soknadsbarnFodselsdato kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarSamvaersklasseSamvaersklasseIdErNull() {
    ...
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("samvaersklasseId kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarLopendeBidragSoknadsbarnIdErNull() {
    var grunnlag = new LopendeBidrag(LocalDate.parse("2021-08-18"), LocalDate.parse("2022-08-18"), null, BigDecimal.valueOf(2000),
  ...
  void skalKasteIllegalArgumentExceptionNaarLopendeBidragBelopErNull() {
    var grunnlag = new LopendeBidrag(LocalDate.parse("2021-08-18"), LocalDate.parse("2022-08-18"), 1, null, BigDecimal.valueOf(1500),
        BigDecimal.valueOf(2000), BigDecimal.valueOf(1500));
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("belop kan ikke være null");
  }
  ...
  void skalKasteIllegalArgumentExceptionNaarLopendeBidragOpprinneligBPAndelUnderholdskostnadBelopErNull() {
    var grunnlag = new LopendeBidrag(LocalDate.parse("2021-08-18"), LocalDate.parse("2022-08-18"), 1, BigDecimal.valueOf(2000), null,
        BigDecimal.valueOf(2000), BigDecimal.valueOf(1500));
  ...
  void skalKasteIllegalArgumentExceptionNaarLopendeBidragOpprinneligBidragBelopErNull() {
    var grunnlag = new LopendeBidrag(LocalDate.parse("2021-08-18"), LocalDate.parse("2022-08-18"), 1, BigDecimal.valueOf(2000),
        BigDecimal.valueOf(1500), null, BigDecimal.valueOf(1500));
    assertThatExceptionOfType(UgyldigInputException.class).isThrownBy(grunnlag::valider).withMessage("opprinneligBidragBelop kan ikke være null");
  }
